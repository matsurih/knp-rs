...
use crate::{Class, fprintf, free, memset, sprintf, sscanf, strcat, strcmp, strcpy, strdup, strlen, strncmp, strstr};
use crate::case_match::cf_match_element;
use crate::configfile::check_dict_filename;
use crate::ctools::{assign_cfeature, check_feature, clear_crf, crf_add, crf_parse, exit, get_crf_prob, malloc_data, Outfp, qsort, stderr, stdout};
...
use crate::types::{BNST_DATA, CF_PRED_MGR, DBM_FILE, FEATURE, NE_CACHE, NE_MANAGER, SENTENCE_DATA, size_t};
