...
use crate::ctools::{exit, malloc_data, Outfp, stderr};
...
#[inline]
unsafe extern "C" fn stat(mut __path: *const libc::c_char, mut __statbuf: *mut stat) -> libc::c_int {
...
pub unsafe extern "C" fn clear_rule_configuration() {
    if CurrentRuleNum != 0 {
        ...
        RULE = 0 as *mut types::RuleVector;
...
/*==================================================================*/
#[no_mangle]
pub unsafe extern "C" fn find_rc_file(mut opfile: *mut libc::c_char) -> *mut types::FILE {
    let mut fp: *mut types::FILE = 0 as *mut types::FILE;
    if !opfile.is_null() {
...
/*==================================================================*/
#[no_mangle]
pub unsafe extern "C" fn read_rc(mut in_0: *mut types::FILE)
 /*==================================================================*/
 {
    let mut cell1: *mut types::CELL = 0 as *mut types::CELL;
    let mut cell2: *mut types::CELL = 0 as *mut types::CELL;
            ...
            while !car(cell1).is_null() {
                if CurrentRuleNum >= RuleNumMax {
                    ...
                    RULE =realloc_data(
                        ...
                        (::std::mem::size_of::<types::RuleVector>() as libc::c_ulong).wrapping_mul(RuleNumMax as libc::c_ulong),
                        b"read_rc\x00" as *const u8 as *const libc::c_char as *mut libc::c_char
                    ) as *mut types::RuleVector
                }
                /* KNP ルールディレクトリ */
                /* KNP ルールファイル */
                /* デフォルト値設定 */
...
/*==================================================================*/
#[no_mangle]
pub unsafe extern "C" fn server_read_rc(mut fp: *mut types::FILE) {
...
#[no_mangle]
pub unsafe extern "C" fn check_data_newer_than_rule(mut data: types::time_t, mut datapath: *mut libc::c_char) {
    /* ルールファイルとの時間チェック */
    ...
    let mut sb: stat =
        stat{st_dev: 0,
             ...
             st_blksize: 0,
             st_blocks: 0,
             st_atim: structs::timespec{tv_sec: 0, tv_nsec: 0,},
             st_mtim: structs::timespec{tv_sec: 0, tv_nsec: 0,},
             st_ctim: structs::timespec{tv_sec: 0, tv_nsec: 0,},
...
pub unsafe extern "C" fn open_dict(mut dic_num: libc::c_int,
                                   ...
                                   mut exist: *mut libc::c_int) -> types::DBM_FILE
 /*==================================================================*/
 {
    let mut index_db_filename: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut db: types::DBM_FILE = 0 as *mut structs::CDB_FILE;
