...
use crate::ctools::{__errno_location, internal_state, malloc_data, realloc, stderr};
use crate::tools;
use crate::types::{Bytef, size_t, uInt, z_stream};


#[no_mangle]
pub static mut sm_db: tools::DBM_FILE = 0 as *const tools::CDB_FILE as *mut tools::CDB_FILE;
#[no_mangle]
pub static mut sm2code_db: tools::DBM_FILE = 0 as *const tools::CDB_FILE as *mut tools::CDB_FILE;
#[no_mangle]
pub static mut smp2smg_db: tools::DBM_FILE = 0 as *const tools::CDB_FILE as *mut tools::CDB_FILE;
#[no_mangle]
...
pub unsafe extern "C" fn db_read_open(mut filename: *mut libc::c_char)
 -> tools::DBM_FILE {
    let mut db: tools::DBM_FILE = 0 as *mut tools::CDB_FILE;
    db =
        malloc_data(::std::mem::size_of::<tools::CDB_FILE>() as libc::c_ulong,
                    b"db_read_open\x00" as *const u8 as *const libc::c_char as
                        *mut libc::c_char) as tools::DBM_FILE;
    (*db).mode = 0 as libc::c_int;
    (*db).fd = open(filename, (*db).mode);
    if (*db).fd < 0 as libc::c_int {
        free(db as *mut libc::c_void);
        return 0 as tools::DBM_FILE
    }
    ...
    db =
        malloc_data(::std::mem::size_of::<tools::CDB_FILE>() as libc::c_ulong,
                    b"db_write_open\x00" as *const u8 as *const libc::c_char
                        as *mut libc::c_char) as tools::DBM_FILE;
    (*db).mode =
...
/* DB close */
#[no_mangle]
pub unsafe extern "C" fn db_close(mut db: tools::DBM_FILE) {
...
/* DB get */
#[no_mangle]
pub unsafe extern "C" fn db_get(mut db: tools::DBM_FILE, mut buf: *mut libc::c_char)
 -> *mut libc::c_char {
...
/* DB put */
#[no_mangle]
pub unsafe extern "C" fn db_put(mut db: tools::DBM_FILE, mut buf: *mut libc::c_char,
