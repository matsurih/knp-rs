...
use crate::ctools::{assign_cfeature, check_dict_filename, get_mrph_rep_from_f, malloc_data, Outfp};
use crate::db;
use crate::tools;
...
#[no_mangle]
pub static mut auto_dic_db: tools::DBM_FILE = 0 as *const tools::CDB_FILE as *mut tools::CDB_FILE;
#[no_mangle]
...
/*==================================================================*/
#[no_mangle]
pub unsafe extern "C" fn check_auto_dic(mut m_ptr: *mut tools::MRPH_DATA,
